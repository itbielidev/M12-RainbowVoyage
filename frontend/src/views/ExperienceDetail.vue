      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-md-6">
            ...
            <p>
              Nuestro hotel, ubicado en el emblemático barrio del Eixample, es mucho más que un
              lugar para alojarse; ¡es un destino en sí mismo! Con un enfoque único en la comunidad
              LGBTQ+, cada detalle refleja nuestra calidez y modernidad.
            </p>
            <p>
              Disfruta de lujosas habitaciones y suites, sumérgete en nuestra piscina en la azotea
              con vistas impresionantes, y explora la rica cultura y vida nocturna de Barcelona.
            </p>
            <p>
